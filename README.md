...
5: The back-end CAD Converter structure must be installed separately, and linked in by setting the back-end server variable  ***var ServerBackEndUrl = "myUrl";*** and ***ServerLocation=myLocation*** to the url of the back-end, found in /src/components/CADViewerCanvas.vue or /src/components/CADViewerCanvas_no_npm.vue .
